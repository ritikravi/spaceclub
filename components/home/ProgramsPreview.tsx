...
const programs = [
  {
    icon: Calendar,
    title: "Space Camps",
    desc: "Intensive multi-day camps with researchers and engineers at different locations.",
    badge: "Residential",
  ...
  },
  {
    ...
    desc: "Team formation, mentoring, mock presentations for ISRO, NASA Space Apps, SIH.",
    badge: "Competitive",
  ...
  },
  {
    icon: BookOpen,
    title: "Research Cell",
    desc: "Guided paper reading, writing, publishing, and patent filing for ambitious students.",
    badge: "Research",
  ...
  },
  {
    icon: Trophy,
    title: "Competitions",
    desc: "ISRO Hackathon, CanSat, CubeSat challenges, Smart India Hackathon, and more.",
    badge: "National",
  ...
  },
  {
    ...
    desc: "Supervised visits to ISRO, IN-SPACe, startups, and research labs.",
    badge: "Exposure",
  ...
  },
  {
    ...
    desc: "National and international professionals connect with students every week.",
    badge: "Online",
    ...
    <section className="py-24 bg-[#060c18]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <SectionHeading
          ...
          subtitle="Not just lectures — actual experiences that shape your career path."
        />
          ...
          {programs.map((p) => (
            <div key={p.title} className="glass glass-hover rounded-2xl p-6">
              <div className="flex items-start justify-between mb-4">
                ...
                <span className={`text-xs px-2 py-1 rounded-full font-medium ${p.badgeColor}`}>
                  {p.badge}
                </span>
              </div>
