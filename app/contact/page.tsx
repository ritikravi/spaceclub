    ...
    <div className="min-h-screen bg-white pt-20">
      <section className="bg-blue-700 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <span className="inline-block px-3 py-1 text-xs font-semibold text-blue-200 bg-white/10 rounded-full mb-4">Contact</span>
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-6">Get in Touch</h1>
          <p className="text-blue-100 text-lg max-w-xl mx-auto">Questions, collaborations, mentorship — reach out anytime.</p>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            {contacts.map((c) => (
              <a key={c.label} href={c.href} className="flex items-center gap-4 glass glass-hover rounded-xl p-4 group">
                <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center group-hover:bg-orange-100 transition-all">
          ...
          <div className="lg:col-span-3">
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="glass rounded-2xl p-8 space-y-5 border-t-4 border-blue-400">
                ...
                <button type="submit" disabled={loading} className="flex items-center gap-2 px-6 py-3 bg-blue-700 hover:bg-blue-800 disabled:opacity-60 text-white font-bold rounded-xl transition-all text-sm shadow-sm">
