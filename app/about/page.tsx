...
const achievements = [
  ...
  { icon: Rocket, value: "3", label: "CanSat Missions Completed", color: "text-orange-600 bg-orange-50" },
    ...
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="bg-orange-500 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <span className="inline-block px-3 py-1 text-xs font-semibold text-orange-200 bg-white/20 rounded-full mb-4">About Us</span>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass rounded-2xl p-8 border-l-4 border-orange-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((m) => (
            <div key={m.name} className="glass glass-hover rounded-2xl p-6 text-center">
              ...
              <div className="text-orange-500 text-sm mt-1">{m.role}</div>
